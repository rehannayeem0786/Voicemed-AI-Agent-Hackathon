...
# ─── Theme (mirrors static/style.css) ───────────────────────────
BG = RGBColor.from_string("0B1220")
PANEL = RGBColor.from_string("131F35")
PANEL2 = RGBColor.from_string("182740")
LINE = RGBColor.from_string("22344F")
TEXT = RGBColor.from_string("E8EEF7")
MUTED = RGBColor.from_string("93A5BD")
...
INK = RGBColor.from_string("081018")  # dark text on accent fills
...
shipped = [
    ...
    ("📊", "Live session UI", "Progress tracker, tool panels, emergency banner"),
